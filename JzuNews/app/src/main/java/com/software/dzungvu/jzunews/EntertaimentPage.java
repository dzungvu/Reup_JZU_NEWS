...
public class EntertaimentPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setTitle("Entertaiment Page");
    ...
    private void addControls() {
        ...
        lvNews.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(EntertaimentPage.this, PopupActivity.class);
    ...
    private boolean haveNetworkConnection() {
        ...
        ConnectivityManager cm = (ConnectivityManager) EntertaimentPage.this.getSystemService(Context.CONNECTIVITY_SERVICE);
        assert cm != null;
    ...
    public class GetRssFile extends AsyncTask<String, Void, ArrayList<NewsElements>> {
        ...
        protected void onPostExecute(ArrayList<NewsElements> newsElementses) {
            ...
            ElementsAdapter elementsAdapter = new ElementsAdapter(EntertaimentPage.this, R.layout.item_news, newsElementsArrayList);
            lvNews.setAdapter(elementsAdapter);
            ElementsGridAdapter elementsGridAdapter = new ElementsGridAdapter(EntertaimentPage.this, R.layout.item_news_grid, newsElementsArrayList);
