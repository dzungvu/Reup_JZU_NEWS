...
public class SportPage extends AppCompatActivity {
    ...
    private void addControls() {
        ...
        lvNews.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(SportPage.this, PopupActivity.class);
    ...
    private boolean haveNetworkConnection() {
        ...
        ConnectivityManager cm = (ConnectivityManager) SportPage.this.getSystemService(Context.CONNECTIVITY_SERVICE);
        assert cm != null;
    ...
    public class GetRssFile extends AsyncTask<String, Void, ArrayList<NewsElements>> {
        ...
        protected void onPostExecute(ArrayList<NewsElements> newsElementses) {
            ...
            ElementsAdapter elementsAdapter = new ElementsAdapter(SportPage.this, R.layout.item_news, newsElementsArrayList);
            lvNews.setAdapter(elementsAdapter);
            ElementsGridAdapter elementsGridAdapter = new ElementsGridAdapter(SportPage.this, R.layout.item_news_grid, newsElementsArrayList);
