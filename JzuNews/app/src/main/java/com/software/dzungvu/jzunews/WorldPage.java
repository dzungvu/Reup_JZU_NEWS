...
public class WorldPage extends AppCompatActivity {
    ...
    private void addControls() {
        ...
        lvNews.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(WorldPage.this, PopupActivity.class);
    ...
    private boolean haveNetworkConnection() {
        ...
        ConnectivityManager cm = (ConnectivityManager) WorldPage.this.getSystemService(Context.CONNECTIVITY_SERVICE);
        assert cm != null;
    ...
    public class GetRssFile extends AsyncTask<String, Void, ArrayList<NewsElements>> {
        ...
        protected void onPostExecute(ArrayList<NewsElements> newsElementses) {
            ...
            ElementsAdapter elementsAdapter = new ElementsAdapter(WorldPage.this, R.layout.item_news, newsElementsArrayList);
            lvNews.setAdapter(elementsAdapter);
            ElementsGridAdapter elementsGridAdapter = new ElementsGridAdapter(WorldPage.this, R.layout.item_news_grid, newsElementsArrayList);
